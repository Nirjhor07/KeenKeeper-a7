...
import { MdMessage, MdOutlineEventNote } from "react-icons/md";
...
const NoStats = () => {
    return (
      ...
      <h2 className="text-2xl font-bold text-gray-700 mb-2">
        No Stats Friends Activity yet!!!
      </h2>
      
      <p className="text-gray-500 mb-6 max-w-md">
        Start logging your interactions by clicking the quick action buttons on the friends profile. Your stats will appear here.
      </p>
